var _0x586b = [
  ...
  "metaData",
  "prototype",
  "fundebug.notifyHttpError()必须指定res参数!",
  "call",
];
(function (t, e) {
  var n = function (e) {
...
module["exports"] = (function (n) {
  ...
  function o(e) {
    ...
    return (
      n[e][_0x275e("0x0")](t[_0x275e("0x1")], t, t["exports"], o),
      (t["l"] = !0),
      t["exports"]
    );
  }
  ...
  function (e, t, n) {
    ...
    (c["init"] = r(s, f, c)),
      (c["test"] = o(s, f, c)),
      (c["notify"] = i(s, f, c)),
      (c["notifyError"] = u(s, f, c)),
      (c["notifyHttpError"] = a(s, f, c)),
      (e["exports"] = c);
  },
  function (e, t, n) {
    function o(e) {
      ...
      return function (t) {
        if (((s = !0), t && "object" === o(t))) {
          [
            ...
            t["silentConsole"] || t["silentBehavior"] || a(e),
            t["silentInject"] ||
              t["silent"] ||
              (i(n, e, r), u(n, e), t["silentHttp"] || c(n, e, r)),
            f["getNetworkType"](),
            t["setSystemInfo"] && f["getSystemInfo"](),
            t["setLocation"] && f["getLocation"]();
        }
      };
    }),
      setTimeout(function () {
        !1 === s &&
          console["error"](
            "请使用fundebug.init(https://docs.fundebug.com/notifier/wxjs/api/init.html)配置apikey!"
          );
      }, 1e3);
  },
  function (e, t, n) {
    ...
    e["exports"] = function (n, r, o) {
      ...
      u["onError"] = function (e) {
        if (e) {
          ...
          (t.error = e),
            (t.type = "uncaught"),
            a.sendToFundebug(t, n.filters, n.sampleRate, n.callback);
        }
      };
      App = function (i) {
  ...
  function (e, t) {
    (t["captureBreadcrumb"] = function (e, t, n) {
      ...
      (t[_0x275e("0x9")] = function (e) {
        return (
          (!e && 0 !== e) ||
          ((e = parseFloat(e)), !!isNaN(e) || Math["random"]() <= e)
        );
      });
  },
  function (e, t, n) {
    ...
    t["sendToFundebug"] = function (e, t, n, r) {
      if (
        ((e["metaData"] = a["copyWithoutCircle"](e["metaData"])),
        (function (e) {
          if (!e["apikey"])
  ...
  function (e, t) {
      ...
      for (var n in t)
        if (t["hasOwnProperty"](n))
          if (t[n]["constructor"] === RegExp) {
            ...
            if (t[n]["constructor"] !== String || "inexistence" !== t[n])
              return !1;
    ...
    t["isFiltered"] = function (e, t) {
      ...
      for (var n = 0; n < t["length"]; n++) if (r(e, t[n])) return !0;
      return !1;
    };
  },
  function (e, t) {
        ...
        (function (e, t) {
          ...
          try {
            for (
              ...
              !(r = (u = a["next"]())[_0x275e("0xb")]) &&
              (n["push"](u["value"]), !t || n[_0x275e("0xc")] !== t);
              r = !0
            );
          } catch (e) {
            (o = !0), (i = e);
    ...
    function c(e) {
      return (c =
        _0x275e("0x8") == typeof Symbol && "symbol" == typeof Symbol["iterator"]
          ? function (e) {
              return typeof e;
            }
          : function (e) {
    ...
    try {
      ...
      if (_0x275e("0xf") === r["platform"])
        parseInt(r["system"]["match"](/iOS (\d+)\./)[1]) < 11 && (n = !0);
    } catch (e) {
      console["error"](e);
    }
                ...
                return (
                  Object["entries"](t)["forEach"](function (e) {
                    var t = a(e, 2),
                      n = t[0],
                      r = t[1];
                    _0x275e("0x11") === c(r) && null !== r
                      ? i["has"](r)
                        ? (u[n] =
                            "property removed because of circular structure")
                        : 10 < i["size"]
                        ? (u[n] = "property removed to avoid deep recursion")
                        : (i["add"](r), (u[n] = o(r, i)))
                      : (u[n] = r);
                  }),
                  u
  ...
  function (e, t, n) {
    ...
    (t["getEvent"] = function (e, t, n) {
      return (
        (i["scene"] = e["scene"]),
        (i["apikey"] = e["apikey"]),
        (i["appVersion"] = e[_0x275e("0x4")]),
        (i["releaseStage"] = e["releaseStage"]),
        (i["metaData"] = n["metaData"] || e["metaData"]),
        (i["breadcrumbs"] = t),
        (i[_0x275e("0x12")] = new Date()["getTime"]()),
        e["silentApp"] ||
          (i[_0x275e("0x13")] = o["copyWithoutCircle"](getApp())),
        e["silentPage"] ||
          (i["Page"] = o["copyWithoutCircle"](r["getCurrentPage"]())),
        i[_0x275e("0x14")] ||
          (n["userInfo"]
            ? (i["userInfo"] = n["userInfo"])
            : e[_0x275e("0x15")] &&
              wx["getUserInfo"]({
                success: function (e) {
    ...
    e["exports"] = function (r, o) {
      ...
      function n(e, t) {
        ...
        e[t] = function () {
          try {
            ("onLoad" !== t && "onShow" !== t) ||
              (r["currentPage"] = a["getCurrentPage"]());
            var e = {};
            e["type"] = _0x275e("0x8");
            ...
            "onLoad" === t && (e["args"] = arguments),
              r["monitorMethodArguments"] &&
                !u(i, t) &&
                (e["args"] = arguments),
              (function (e) {
                ...
                return t && t[_0x275e("0xc")]
                  ? Boolean(u(t, e))
                  : !n || !n["length"] || Boolean(!u(n, e));
      ...
      Page = function (t) {
        i[_0x275e("0x1a")](function (e) {
          ...
          r[_0x275e("0x1b")] &&
            Object[_0x275e("0x1c")](t)["forEach"](function (e) {
  ...
  function (e, t, n) {
    ...
    e["exports"] = function (r) {
      ["log", _0x275e("0x1d"), _0x275e("0x1e"), "warn"]["forEach"](function (
        e
      ) {
        var t, n;
        (t = e),
          ...
          (console[t] = function () {
            ...
            _0x275e("0x1d") === t &&
            arguments[0] &&
            /^\[non-writable\] modification of global variable ".+" is not allowed when using plugins at app\.json\.$/[
              "test"
            ](arguments[0])
              ? (n && n["apply"](this, arguments),
                console["error"](
                  "当使用小程序插件时，微信禁止Fundebug重写App/Page/wx等全局变量，请使用fundebug.init将silentInject(https://docs.fundebug.com/notifier/wxjs/customize/silentinject.html)设为true，并使用fundebug.notifyError(https://docs.fundebug.com/notifier/wxjs/api/notifyerror.html)上报onError捕获的错误。详情请查看Fundebug文档(https://docs.fundebug.com/notifier/wxjs/other/non_writable.html)"
                ))
              : n && n["apply"](this, arguments);
          });
      });
      ...
      return function (e, t) {
        try {
          ...
          if (e && "string" != typeof e)
            return void console[_0x275e("0x1d")](
    ...
    e["exports"] = function (o, i, u) {
      return function (e, t, n) {
        try {
          if (o["silent"]) return;
          if (!e)
            return void console["error"]("fundebug.notify()必须指定name参数!");
          if ("string" != typeof e)
            return void console["error"](
              "fundebug.notify()的name参数类型必须为string!"
            );
          if (t && "string" != typeof t)
            return void console["error"](_0x275e("0x23"));
          if (n && "object" !== a(n))
            return void console[_0x275e("0x1d")](
          ...
          (r["type"] = "notification"),
            (r["name"] = e),
            (r["message"] = t),
            n && n["metaData"] && (r[_0x275e("0x24")] = n["metaData"]),
            c["sendToFundebug"](
              r,
              o["filters"],
              o["sampleRate"],
    ...
    e["exports"] = function (o, i, u) {
      return function (e, t, n) {
        try {
          ...
          if (!e)
            return void console["error"](
              "fundebug.notifyHttpError()必须指定req参数!"
            );
          if (!t) return void console[_0x275e("0x1d")](_0x275e("0x26"));
          if (e && "object" !== a(e))
            return void console["error"](
              "fundebug.notifyHttpError()的req参数类型必须为object!"
            );
          if (t && "object" !== a(t))
            return void console["error"](
              "fundebug.notifyHttpError()的res参数类型必须为object!"
            );
          if (n && "object" !== a(n))
            return void console[_0x275e("0x1d")](
              "fundebug.notifyHttpError()的option参数类型必须为object!"
            );
          var r = f["getEvent"](o, i, u);
          (r["type"] = "httpError"),
            (r["req"] = e),
            (r["res"] = t),
            n && n["metaData"] && (r["metaData"] = n["metaData"]),
            c["sendToFundebug"](
              r,
              o["filters"],
              o["sampleRate"],
